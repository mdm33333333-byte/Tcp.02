...
uid=4528763637,password=A698CEB39EB16F35AFB989EBEC6E882DAAD69B4383696336C597F2FA19016BD9
...
🤖 Bot Name: @NAJMI_ADMIN
✅ Status: Ready to join

📱 Player will see:
"@NAJMI_ADMIN wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]@NAJMI_ADMIN [00FF00]___ @NAJMI_ADMIN____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @@NAJMI_ADMIN\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde @NAJMI_ADMIN ya meku agar tu noob bolra toh tu g a y hai
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO @NAJMI_ADMIN BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000] @NAJMI_ADMIN
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@@NAJMI_ADMIN
[00FF00]»»————-　★　————-««
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by @NAJMI_ADMIN
/bio Level 70 | Pro Player
/bio Add me: @NAJMI_ADMIN
...
[b][i][FFC0CB]youtube: @NAJMI_ADMIN 99[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @@NAJMI_ADMIN[/b]

[b][c][FFA500]telegram contact: @@NAJMI_ADMIN[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by Black666FF
Modified by - @NAJMI_ADMIN
"""
...
#==================≈===========  /HELP MENU COMMANDS ========================================
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "hello", "hi"):
                            ...
                            header = f"[C][B][FF1493]Hey User Welcome To [00FFAA]@NAJMI_ADMIN's BOT"
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4528607351,password=CA3JDIEJ8373738NSJDBUDHEHE8263BEKSOXHNWB8273HDNEJEUDGDB")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 @NAJMI_ADMIN BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 @NAJMI_ADMIN BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 @NAJMI_ADMIN BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
